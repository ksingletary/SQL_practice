...
INSERT INTO products (name, price, can_be_returned) VALUES ('Record Player', 179.99, false);
...
SELECT name, price, can_be_returned FROM products WHERE price BETWEEN 22.50 AND 99.00;
